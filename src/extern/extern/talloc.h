 ...
 * @return             The allocated memory chunk, NULL on error.
 */
    void *talloc_named_const(const void *context, size_t size,
                             const char *name);
 ...
 *                      error.
 */
    void *talloc_array_ptrtype(const void *ctx, const void *ptr,
                               unsigned count);
#else
 ...
 */
    void *talloc_realloc(const void *ctx, void *ptr,
#type, size_t count);
#else
 ...
 */
    char *talloc_vasprintf_append(char *s, const char *fmt,
                                  va_list ap) PRINTF_ATTRIBUTE(2, 0);
 ...
 * @see talloc_vasprintf()
 */
    char *talloc_vasprintf_append_buffer(char *s, const char *fmt,
                                         va_list ap) PRINTF_ATTRIBUTE(2, 0);
