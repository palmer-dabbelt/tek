...
#ifndef PROCESSOR_SOURCE_H
#define PROCESSOR_SOURCE_H

#include "processor.h"

struct processor_source
{
    struct processor p;
};

extern void processor_source_boot(void *context);

extern struct processor *processor_source_search(void *context,
                                                 const char *filename);
