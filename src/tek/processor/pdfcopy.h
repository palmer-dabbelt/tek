...
#ifndef PROCESSOR_PDFCOPY_H
#define PROCESSOR_PDFCOPY_H

#include "processor.h"

struct processor_pdfcopy
{
    struct processor p;
};

extern void processor_pdfcopy_boot(void *context);

extern struct processor *processor_pdfcopy_search(void *context,
                                                  const char *filename);
