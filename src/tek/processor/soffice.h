...
#ifndef PROCESSOR_SOFFICE_H
#define PROCESSOR_SOFFICE_H

#include "processor.h"
#include <stdbool.h>

struct processor_soffice
{
    struct processor p;
...
extern void processor_soffice_boot(void *context);

extern struct processor *processor_soffice_search(void *context,
                                                      const char *filename);
